...
def seed_products():
    ...
    bagel = Product(
        ...
        quantity=randint(1, 20), created_at=datetime.utcnow(), updated_at=datetime.utcnow(), seller_id=randint(1, 3), image_url="https://i.imgur.com/RKMkkny.jpg", category_id=2
    )
    bread = Product(
        name="Bread", description="This is a great product. The best product. The best you've ever had. You should buy it.", price=18,
        quantity=randint(1, 20), created_at=datetime.utcnow(), updated_at=datetime.utcnow(), seller_id=randint(1, 4), image_url="https://i.imgur.com/z3Xe6nG.jpg", category_id=2
    )
    cheesecake = Product(
        name="Cheesecake", description="This is a great product. The best product. The best you've ever had. You should buy it.", price=20,
        quantity=randint(1, 20), created_at=datetime.utcnow(), updated_at=datetime.utcnow(), seller_id=randint(1, 4), image_url="https://i.imgur.com/n87eflj.jpg", category_id=3
    )
    chocolate_chip = Product(
        ...
        quantity=randint(1, 20), created_at=datetime.utcnow(), updated_at=datetime.utcnow(), seller_id=randint(1, 4), image_url="https://i.imgur.com/cugUb0s.jpg", category_id=4
    )
    oatmeal = Product(
        ...
        quantity=randint(1, 20), created_at=datetime.utcnow(), updated_at=datetime.utcnow(), seller_id=randint(1, 4), image_url="https://i.imgur.com/yRAEN0D.jpg", category_id=4
    )
    cranberry = Product(
        ...
        quantity=randint(1, 20), created_at=datetime.utcnow(), updated_at=datetime.utcnow(), seller_id=randint(1, 4), image_url="https://i.imgur.com/OPKI9qv.jpg", category_id=4
    )
    pb_chocolate = Product(
        ...
        quantity=randint(1, 20), created_at=datetime.utcnow(), updated_at=datetime.utcnow(), seller_id=randint(1, 4), image_url="https://i.imgur.com/XEjD34Z.jpg", category_id=4
    )
    macarons = Product(
        name="Macarons", description="This is a great product. The best product. The best you've ever had. You should buy it.", price=22,
        quantity=randint(1, 20), created_at=datetime.utcnow(), updated_at=datetime.utcnow(), seller_id=randint(1, 4), image_url="https://i.imgur.com/fJ1Rvws.jpg", category_id=5
    )
    smores = Product(
        ...
        quantity=randint(1, 20), created_at=datetime.utcnow(), updated_at=datetime.utcnow(), seller_id=randint(1, 4), image_url="https://i.imgur.com/RS74Bte.jpg", category_id=4
    )
    brownies = Product(
        name="Brownies", description="This is a great product. The best product. The best you've ever had. You should buy it.", price=14,
        quantity=randint(1, 20), created_at=datetime.utcnow(), updated_at=datetime.utcnow(), seller_id=randint(1, 4), image_url="https://i.imgur.com/fkqcqKt.jpg", category_id=5
    )
