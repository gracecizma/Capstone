...
def seed_products():
    bagel = Product(
        ...
        quantity=randint(1, 20), created_at=datetime.utcnow(), updated_at=datetime.utcnow(), seller_id=1, image_url="https://i.imgur.com/1voMqed.jpg", category_id=1
    )
    bread = Product(
        ...
        quantity=36, created_at=datetime.utcnow(), updated_at=datetime.utcnow(), seller_id=1, image_url="https://i.imgur.com/hR38qAc.jpg", category_id=1
    )
    cheesecake = Product(
        ...
        quantity=1, created_at=datetime.utcnow(), updated_at=datetime.utcnow(), seller_id=1, image_url="https://i.imgur.com/ZTVH7yw.jpg", category_id=2
    )
    chocolate_chip = Product(
        ...
        quantity=36, created_at=datetime.utcnow(), updated_at=datetime.utcnow(), seller_id=1, image_url="https://i.imgur.com/RyuJRCk.jpg", category_id=3
    )
    oatmeal = Product(
        ...
        quantity=36, created_at=datetime.utcnow(), updated_at=datetime.utcnow(), seller_id=1, image_url="https://i.imgur.com/kFDhSkh.jpg", category_id=3
    )
    cranberry = Product(
        ...
        quantity=36, created_at=datetime.utcnow(), updated_at=datetime.utcnow(), seller_id=1, image_url="https://i.imgur.com/4kmZ6jX.jpg", category_id=3
    )
    pb_chocolate = Product(
        ...
        quantity=36, created_at=datetime.utcnow(), updated_at=datetime.utcnow(), seller_id=1, image_url="https://i.imgur.com/6cf9QZB.jpg", category_id=3
    )
    macarons = Product(
        ...
        quantity=36, created_at=datetime.utcnow(), updated_at=datetime.utcnow(), seller_id=1, image_url="https://i.imgur.com/Kp0ZsdS.jpg", category_id=3
    )
    # smores = Product(
    ...
    brownies = Product(
        ...
        quantity=32, created_at=datetime.utcnow(), updated_at=datetime.utcnow(), seller_id=1, image_url="https://i.imgur.com/O2bWVOo.jpg", category_id=4
    )
